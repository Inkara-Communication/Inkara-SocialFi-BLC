...
contract CommunityCrafting {
    ...
    function payOut(uint sff, address owner) public payable {
        ...
        ERC20(0xdf9B4b57865B403e08c85568442f95c26b7896b0).transferFrom(
            msg.sender,
            address(this),
            values[1]
        );
        // Approve the router just in case
        ERC20(0xdf9B4b57865B403e08c85568442f95c26b7896b0).approve(
            0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff,
            values[1]
        );

        (uint amountToken, uint amountETH, uint liquidity) = uniswapV2Router
            .addLiquidityETH{value: values[0]}(
        ...
        (bool sentTeam, bytes memory data2) = sunflowerTeam.call{
            value: sunflowerCommision
        }("");
    ...
    function getRecipe(
        address recipe
    ) public view returns (CommunityRecipe memory) {
